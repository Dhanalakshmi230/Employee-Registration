    ...
    <div className="container mt-3">
      ...
      <div class="row jumbotron box8">
        ...
        <div class="col-sm-6 form-group">
          ...
          <input type="text" class="form-control" name="Firstname" id="name-f" placeholder="Enter your first name."  value={formData.Firstname} onChange={handleChange} required />
        </div>
        <div class="col-sm-6 form-group">
          <label for="name-l">Last name</label>
                      <input type="text" class="form-control" name="Lastname" id="name-l" placeholder="Enter your last name." value={formData.Lastnamename} onChange={handleChange} required />
        </div>
        <div class="col-sm-6 form-group">
        ...
        <div class="col-sm-6 form-group">
          ...
          <input type="Password" name="Password" class="form-control" id="pass" placeholder="Enter your password." value={formData.Password} onChange={handleChange} required />
        </div>
        <div class="col-sm-6 form-group">
          <label for="pass2">Confirm Password</label>
          <input type="Password" name="ConfirmPassword" class="form-control" id="pass2" placeholder="Re-enter your password." value={formData.ConfirmPassword} onChange={handleChange} required />
        </div>
        <div class="col-sm-12">
